#!/usr/bin/python
#========================================================================
#  Subroutine that calculates the beginning and end dates of the rainy season
...
import sys
import numpy
def rainyseason_B17_onset(nyrs,ytot,jday,day,month,year,jstart,precip,npass,sjday,sday,smonth,syear):
